...
class User extends Model
{
      ...
      public function save()
      {
            ...
            $query = "INSERT INTO tb_user SET user_email=:user_email, user_password=PASSWORD(:user_password), user_full_name=:user_full_name, user_alamat=:user_alamat, user_hp=:user_hp, user_pos=:user_pos, user_role=:user_role, user_aktif=:user_aktif";
            $stmt = $this->db->prepare($query);
