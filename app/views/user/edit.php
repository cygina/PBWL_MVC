...
<form action="<?php echo URL; ?>/user/update" method="post">
    ...
    <table>
        ...
        <tr>
            <td>ALAMAT</td>
            <td><textarea name="user_alamat" id="" cols="20" rows="10"><?php echo $data['row']['user_alamat'];?></textarea></td>
        </tr>
        <tr>
            <td>NO HP</td>
        ...
        <tr>
            <td>AKTIF</td>
            <td>
            <input type="text" name="user_aktif" value="<?php echo $data['row']['user_aktif']; ?>" required></td>
            </td>
        </tr>
        <tr>
            <td></td>
